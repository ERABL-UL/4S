...
# Start training
# python contrastive_train.py --use-cuda --use-intensity --segment-contrast --checkpoint segcontrast --data-dir $SLURM_TMPDIR/Data/SemanticKITTI --vicreg --batch-size 32 --feature-size 128 --num-workers 8
